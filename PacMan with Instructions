...
var pos = 0;
//pageWidth is the width of the webpage. This is later used to calculate when 
//Pac-Man needs to turn around. 
...
// This variable helps determine which PacMan image should be displayed. It flips 
//between values 0 and 1
var focus = 0;

// This function is called on mouse click. Every time it is called, it updates the 
//PacMan image, position and direction on the screen.
...
// TODO: Add a Javascript setInterval() method that will call the Run() function above 
